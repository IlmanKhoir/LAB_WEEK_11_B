...
class MediaContentHelper {
    ...
    fun generateImageContentValues(fileInfo: FileInfo): ContentValues = ContentValues().apply {
    ...
    fun generateVideoContentValues(fileInfo: FileInfo): ContentValues = ContentValues().apply {
